...
public class NBTChunkData extends ChunkData {
    ...
    public void load() throws WorldData.WorldDBLoadException, WorldData.WorldDBException, IOException {
        ...
        loadFromByteArray(chunk.getWorldData().getChunkData(chunk.mChunkX, chunk.mChunkZ, dataType, chunk.mDimension));
    }
    ...
    public void write() throws WorldData.WorldDBException, IOException {
        ...
        Chunk chunk = this.chunk.get();
        chunk.getWorldData().writeChunkData(chunk.mChunkX, chunk.mChunkZ, this.dataType, chunk.mDimension, data);
    }
