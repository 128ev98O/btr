...
public enum Version {
    ...
    V1_16_PLUS("v1.16.100", "val is replaced by block states", 0x15, 16, 16),
    V1_18_30_PLUS("v1.18.30", "World height map is changed", 40, 16, 24);

    public static final Version LATEST_SUPPORTED_VERSION = V1_18_30_PLUS;
    ...
    public static Version getVersion(@Nullable byte[] data) {
        //Log.d("Data version: "+ Converter.bytesToHexStr(data));
