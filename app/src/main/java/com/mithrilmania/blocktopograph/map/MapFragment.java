...
public class MapFragment extends Fragment {
    ...
    private static final Map<NamedBitmapProvider, BitmapChoiceListAdapter.NamedBitmapChoice> markerFilter = new HashMap<>();
    ...
    private final CopyOnWriteArraySet<AbstractMarker> proceduralMarkers = new CopyOnWriteArraySet<>();

    private final Set<AbstractMarker> staticMarkers = new HashSet<>();
    ...
    private void moveCameraToPlayer(View view) {
        if (Math.random() < 2) {
            try {
                ...
                for (int z = 0; z < 16; z++)
                    chunk.setBlock(0, 6, z, 0, new Block.Builder(KnownBlockRepr.B_5_0_PLANKS_OAK.identifier).build());
...
//            Log.logFirebaseEvent(activity, Log.CustomFirebaseEvent.GPS_LOCATE);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            ...
            AbstractMarker spawnMarker = new AbstractMarker(spawnPos.x, spawnPos.y, spawnPos.z, spawnPos.dimension,
