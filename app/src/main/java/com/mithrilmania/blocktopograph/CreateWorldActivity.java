...
//        Log.logFirebaseEvent(this, Log.CustomFirebaseEvent.CREATE_WORLD_OPEN);
    ...
    private static class CreateWorldTask extends AsyncTask<Void, Void, Boolean> {
        ...
        private final WeakReference<CreateWorldActivity> context;
        ...
        private CreateWorldTask(CreateWorldActivity parent) {
            this.context = new WeakReference<>(parent);
        }

        @Override
        protected void onPreExecute() {
            CreateWorldActivity activity = context.get();
            if (activity == null) {
                canProceed = false;
                return;
            }
            ...
            mBiome = biome == null ? Biome.PLAINS.id : biome.id;
        ...
        protected Boolean doInBackground(Void... voids) {
            ...
            if (mVersion == R.id.version_aqua) {
                verStr = "1_2_13";
            } else if (mVersion == R.id.version_1_18_30) {
                verStr = "1_18_30";
            } else {
                verStr = "unknown";
            }
            ...
            // Modify dat.
            {
                ...
                ArrayList<Layer> alayers = new ArrayList<>(Math.max(lsize, 3));
                var layers2 = layers.values().toArray();
                for (var layer : layers2) {
                    alayers.add((Layer) layer);
                }
...
//            }
        ...
        protected void onPostExecute(Boolean completed) {
            ...
            Toast.makeText(activity,
                    activity.getString(completed ? R.string.general_done : R.string.general_failed),
